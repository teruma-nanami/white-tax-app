...
@section('title', $ledger->fiscal_year . '年分 確定申告・控除編集')

@section('content')
  <div class="container py-4">

    <h1 class="h4 mb-4">
      {{ $ledger->fiscal_year }}年分 確定申告・控除編集
    </h1>
    ...
    <form method="POST" action="{{ route('filing.deductions.update', ['ledger' => $ledger->id]) }}">
      @csrf
      @method('PUT')
        ...
        <div class="card-body">
          ...
          <div class="mb-3">
            ...
            <input type="number" name="salary_life_insurance_ded" class="form-control"
              value="{{ old('salary_life_insurance_ded', $taxFilingData->salary_life_insurance_ded) }}" min="0">
          </div>
          ...
          <div class="form-check mb-3">
            <input class="form-check-input" type="checkbox" name="salary_spouse_ded_applied" value="1"
              ...
              {{ old('salary_spouse_ded_applied', $taxFilingData->salary_spouse_ded_applied) ? 'checked' : '' }}>
        ...
        <div class="card-body">
          ...
          <div class="form-check mb-3">
            <input class="form-check-input" type="checkbox" name="spouse_deduction_applied" value="1"
              ...
              {{ old('spouse_deduction_applied', $taxFilingData->spouse_deduction_applied) ? 'checked' : '' }}>
